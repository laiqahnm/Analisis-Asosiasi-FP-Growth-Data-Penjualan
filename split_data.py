...
df_training.to_excel("dataset/data_training6040.xlsx", index=False)
df_testing.to_excel("dataset/data_testing6040.xlsx", index=False)
...
print("dataset/data_training6040.xlsx")
print("dataset/data_testing6040.xlsx")